...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String username) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("quizgamebyatr/icons/quiz.jpg"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(0, 0, 858, 280);
        add(l1);
        ...
        lifeline.setBounds(650, 380, 150, 30);
    ...
    public void start(int count) {
        ...
        //optns not to be selected automatically
    ...
    //Paint function for next question
    @Override
